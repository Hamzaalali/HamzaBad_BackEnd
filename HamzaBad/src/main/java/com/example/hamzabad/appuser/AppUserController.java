...
public class AppUserController {
    ...
    Role createRole(@RequestBody Role role){
        return appUserService.createRole(role.getRoleName());
    }

    @PostMapping(path = "/{userName}/role")
    AppUser addRoleToUser(@PathVariable String username,@RequestBody Role role){
        return appUserService.addRoleToUser(username,role.getRoleName());
    }
